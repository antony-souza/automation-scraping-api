...
export const needPaymentMessage = (name: string, boletos: string) => `📌 Lembrete importante: ${name}, seu pagamento da Unicesumar está em aberto.

${boletos}

Para evitar bloqueios ou restrições, recomendamos que regularize o quanto antes! 😉`;
